...
<!DOCTYPE html>
<head><title>Asmitha B MD5 Cracker</title></head>
<body>
<h1>MD5 cracker</h1>
...
if ( isset($_GET['md5']) ) {
        ...
        for($j=0; $j<strlen($txt); $j++ ) {
            ...
            for($k=0; $k<strlen($txt); $k++ ) {
                ...
                for($l=0; $l<strlen($txt); $l++ ) {
                    ...
                    $counter+=1;   // a counter to find the number of possibitiies considered to crack the MD5
    ...
    print "\nNumber of possibitiies considered to crack the MD5: $counter\n";
